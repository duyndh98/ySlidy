...
namespace ySlide
{
    ...
    public class Document  : Window
    {
        ...
        public ObservableCollection<Canvas> slides;
        ...
        public Document()
        {
            ...
            slides = new ObservableCollection<Canvas>();
        ...
        public Document(ObservableCollection<Canvas> l)
        {
            slides = l;
            thumbs = new ObservableCollection<System.Windows.Controls.Image>();
            canvas = slides.First<Canvas>();
            DrawType = DrawType.nothing;
            foreach(Canvas item in l)
            {
        ...
        public string OpenFile()
        {
            ...
            try
            {
                if (dlg.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    ...
                    {
                        Canvas deepCopy = System.Windows.Markup.XamlReader.Parse(item) as Canvas;
                        AddSlide(deepCopy);
                    }
                }
            }
        ...
        public void SaveFile(string path = null)
        {
            ...
            foreach(Canvas item in Instance.slides)
            {
        ...
        private System.Windows.Controls.Image CanvasToImage(Canvas c)
        {
            System.Windows.Controls.Image img = new System.Windows.Controls.Image();
